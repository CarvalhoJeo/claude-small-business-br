...
version: 0.2.1-br
description: >
  Prioritizes inbound leads for Brazilian SMBs using any mix of RD Station,
  spreadsheets, WhatsApp lead logs, Instagram DMs transcribed into a sheet, CRM
  exports, or pasted sales notes. Produces a ranked follow-up list with talking
...
- Never require a formal CRM if other workable lead data exists.
